...
void MPU_Config(void)
{
  ...
  */
  /* Configure the MPU attributes as Device not cacheable for ETH DMA descriptors and buffers in D2 SRAM */
  /* RAM_D2 starts at 0x30000000. Size is 288KB. We use 512KB region to cover it all. */
